...
public interface RNSVGSvgViewAndroidManagerInterface<T extends View> {
  ...
  void setBorderTopStartRadius(T view, double value);
  void setBorderTopEndRadius(T view, double value);
  void setBorderBottomStartRadius(T view, double value);
  void setBorderBottomEndRadius(T view, double value);
